...
public class PhysicsSetting extends ToggleGroup {
    ...
    @Configurable(name = "粒子碰撞", tips = "photon.emitter.config.physics.hasCollision")
    protected boolean hasCollision = true;
    @Configurable(name = "粒子碰撞实体时移除", tips = "photon.emitter.config.physics.removedWhenCollided")
    protected boolean removedWhenCollided = false;
    @Configurable(name = "摩擦力", tips = "photon.emitter.config.physics.friction")
    ...
    @Configurable(name = "重力", tips = "photon.emitter.config.physics.gravity")
    ...
    @Configurable(name = "反弹概率", tips = "photon.emitter.config.physics.bounceChance")
    ...
    @Configurable(name = "反弹速度", tips = "photon.emitter.config.physics.bounceRate")
    ...
    @Configurable(name = "反弹扩散率", tips = "photon.emitter.config.physics.bounceSpreadRate")
